...
export class ManageProductComponent implements OnInit {
  displayedColumns: string[] = ['name', 'categoryId', 'description', 'price', 'edit'];
  dataSource: any;
  responseMessage: any;
  ...
  deleteProduct(id: any) {
    this.productService.delete(id).subscribe(
      (response: any) => {
        this.tableData();
        this.responseMessage = response ? response.message : 'Delete successful';
  ...
  onChange(status: any, id: any) {
    ...
    this.productService.updateStatus(data).subscribe(
      (response: any) => {
        this.responseMessage = response?.message || 'Status updated successfully';
        this.snackbarService.openSnackBar(this.responseMessage, "success");
      },
      (error: any) => {
        console.log(error);
